local font1 = dxCreateFont("font/font.ttf", 10+1)
local font_10 = dxCreateFont("font/font.ttf", 10+1)
local font_11 = dxCreateFont("font/font.ttf", 9+1)
                                ...
                                if #cData > 0 then
                                    ...
                                    for iIndex = seeFrom, seeTo do
                                        ...
                                        if cData[iIndex] then
                                            ...
                                            -- Draw the item text
                                            dxDrawText ( cData[iIndex]["text"], x + 10, y, cData.info.width + x, ( 30 % data.h ) + y + 5, tocolor ( 0, 0, 0, 255), FIT_MODE and ( 1 * SCALE ) or 1, font_11, "left", "center", true, true, data.pg, false, true );
                                        end
                                    end
                                end
